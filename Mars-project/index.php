...
<?php get_header(); ?>
        ...
        <div class="breaking-news-container">
            <?php
            $breaking_news = new WP_Query("category_name=breaking-news&posts_per_page=3");
        ...
        <?php 
            ...
            $page_slug = in_array($page_name, ['service', 'services', 'tjänst', 'tänster', 'product', 'produkter', 'produkt', 'products', 'tjanster', 'tjanst', 'tjansten', 'tjansterna']);
